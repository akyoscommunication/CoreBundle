...
class FrontController extends AbstractController
{
    ...
    /**
     * @Route("/{slug}", name="page", methods={"GET"}, requirements={"slug"="^(?!admin|app|archive|details|categorie).+"})
     */
    ...
    /**
     * @Route("page_preview/{slug}", name="page_preview", methods={"GET"}, requirements={"slug"="^(?!admin|app|archive|details|categorie).+"})
     */
    ...
    /**
     * @Route("/archive/{entitySlug}", name="archive", methods={"GET"})
     */
    ...
    /**
     * @Route("/details/{entitySlug}/{slug}", name="single", methods={"GET"})
     */
    ...
    /**
     * @Route("/details_preview/{entitySlug}/{slug}", name="single_preview", methods={"GET"})
     */
    ...
    /**
     * @Route("/categorie/{entitySlug}/{category}", name="taxonomy", methods={"GET"})
     */
