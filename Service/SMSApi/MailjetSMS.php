...
class MailjetSMS
{
    ...
    public function __construct(ParameterBagInterface $params, private readonly MessageLogger $messageLogger, private readonly RequestStack $requestStack, private readonly ErrorCatcher $catcher)
    {
    ...
    public function sendSMS(string $phoneNumber, string $body, bool $doNotFlush = null): array|bool
    {
        ...
        $sms = ['Text' => $body, 'To' => $phone, 'From' => $this->sender];
